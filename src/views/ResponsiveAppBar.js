          ...
          <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" } }}>
            ...
            >
              <MenuItem onClick={handleCloseNavMenu}>
                <Link to={"/rencontre"}>
                  <Typography textAlign="center">Rencontres</Typography>
                </Link>
              </MenuItem>
              <MenuItem onClick={handleCloseNavMenu}>
                <Link to={"/rocket"}>
                  <Typography textAlign="center">Rocket League</Typography>
                </Link>
              </MenuItem>
              <MenuItem onClick={handleCloseNavMenu}>
                <Link to={"/lol"}>
                  <Typography textAlign="center">League of legends</Typography>
                </Link>
              </MenuItem>
              <MenuItem onClick={handleCloseNavMenu}>
                <Link to={"/valorant"}>
                  <Typography textAlign="center">Valorant</Typography>
                </Link>
              </MenuItem>
              <MenuItem onClick={handleCloseNavMenu}>
                <Link to={"/addrenc"}>
                  <Typography textAlign="center">
                    Ajouter une recontre
                  </Typography>
                </Link>
              </MenuItem>
            </Menu>
